##### Scripts for frequentist stats and plotting of [rCPT](https://github.com/sronilsson/Rodent-continous-performance-task-in-psychopy) and [SQLite](https://github.com/sronilsson/h5_to_SQLite_CPT) output data
